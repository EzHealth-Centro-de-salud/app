...
type Props = NativeStackScreenProps<RootStackParamList, "ValidateCode_Pat">;

const ValidateCode_Pat: React.FC<Props> = ({ navigation: { navigate } }) => {
...
export default ValidateCode_Pat;
